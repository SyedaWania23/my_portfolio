     ...
     px-10 
      w-1/2 h-32  rounded-2xl bg-teal-200 py-5  transition duration-500 ease-in-out   hover:shadow-lg transform 
        ...
        <p className='text-left  text-sm font-normal mt-1 '>I
          design visually compelling graphics that effectively communicate your brand&apos;s message. From logos to marketing materials, I create custom designs that are both creative and aligned with your business identity.
        ...
        <p className='text-left  text-sm font-normal mt-1 '>I provide expert-level proficiency in Microsoft Office applications, including Word, Excel, PowerPoint.From creating detailed reports to designing impactful presentations, I ensure accuracy in all tasks.
