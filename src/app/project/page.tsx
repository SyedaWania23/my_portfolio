  ...
  return (
    <div className='bg-black min-h-screen'>
      ...
      <h1 className='text-white text-5xl shadow-teal-500/50 
       mx-72 px-20 shadow-lg font-extrabold'><span className='animate-pulse'>Selected</span><span className='text-teal-200'> Projects</span></h1>
       </div>
       ******************
        ...
        h-96  transition duration-500 ease-in-out   hover:shadow-lg transform 
                       hover:-translate-y-1 hover:scale-105 p-1   '>
                        ...
                        <h1 className='text-white text-center
                         ...
                         <p className='text-white mt-3 text-left px-4 text-sm font-normal '>I built a Car Website, with the help of Nextjs and TailwindCSS,showcasing my front-end development skills.
